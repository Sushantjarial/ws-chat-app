/*
  ...
  - You are about to drop the column `slog` on the `Room` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Room_slog_key";

-- AlterTable
ALTER TABLE "Room" DROP COLUMN "slog",
